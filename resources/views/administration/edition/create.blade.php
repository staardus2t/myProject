    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Ajouter édition</span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('edition.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Portlet-->
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-3 col-md-9 col-sm-12">
                                                <div class="input-group date">
                                                    <input name="date_publication" type="text" class="form-control m-input" readonly placeholder="" id="m_datepicker_2"   />
...
<script>
    ...
    var active  = document.getElementById('create_edition');
