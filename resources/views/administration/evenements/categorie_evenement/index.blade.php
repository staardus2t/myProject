            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Catégories d'événement</span>
                    </a>
                </li>
                <li class="m-nav__separator">-</li>
                <li class="m-nav__item">
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('categorie_evenement.create') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                            <span>
                        ...
                        <td style="text-align:center;">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <a class="dropdown-item" href="{{route('categorie_evenement.valider',$categorie->slug)}}" 
                                        onclick="return confirm('Confirmer cette action ?');">
                                        <i class="la la-edit"></i> &nbsp; {{ $categorie->valide ? 'Annuler validation' : 'Valider'}}
                                    </a>
                                    @if($categorie->valide)
                                    <a class="dropdown-item" href="{{route('categorie_evenement.publier',$categorie->slug)}}" 
                                        onclick="return confirm('Confirmer cette action ?');">
                                        <i class="la la-edit"></i> &nbsp; {{ $categorie->publish ? 'Annuler publication' : 'Publier'}}
                                    </a>
                                    @endif

                                    <a class="dropdown-item" href="{{route('categorie_evenement.edit',$categorie->slug)}}">
                                        <i class="la la-edit"></i> &nbsp; Modifer
                                    </a>
                                    
                                    <form action="{{ route('categorie_evenement.destroy', $categorie->slug)}}" method="POST" id="formDelete">
                                        @csrf
                                        @method('DELETE')
...
<script>
    var li  = document.getElementById('categorie_evenement');
    li.setAttribute('class', 'm-menu__item m-menu__item--submenu m-menu__item--open');

    var active  = document.getElementById('index_categorie_evenement');
