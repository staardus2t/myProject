    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Catégorie d'événement</span>
                    </a>
                </li>
                <li class="m-nav__separator">-</li>
                <li class="m-nav__item">
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('categorie_evenement.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Portlet-->
...
<script>
    ...
    var active  = document.getElementById('create_categorie_evenement');
